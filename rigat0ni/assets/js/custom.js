...
jQuery(function($){
  ...
  /*
	...
	$("#nonselected").delegate(".clickable", "click", function(){
		if( $(.clickable).parent().attr("id") == "nonSelected" ){
			$(.clickable).detach().appendTo('#selected');
		}
		else{
			$(.clickable).detach().appendTo('#nonSelected'); 
		}
  ...
  */
  ...
  $("#booka").click(function(){
    $("#bookp").text("BOOKING CONFIRMED. Our staff will contact you shortly");
});
